      ...
      <Grid gutter={50} className={`font-sans`}>
        ...
        >
          <animated.div style={rightColAnimation} className={`max-lg:mt-10`}>
            ...
            >
              Welcome to <span className=" text-primary">MEDIA</span>
              <span className=" text-stone-500">INCRE</span> – Increase Your
              Worth
            </Title>

            <Text className="mt-2">
              Elevating your company through strategic marketing solutions and
              innovative digital strategies, we’re dedicated to propelling your
              brand to new heights in the ever-evolving marketplace.
            </Text>
